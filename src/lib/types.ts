export type FundRow = {
  ...
  xueqiu_link: string;
  doc_prospectus: string;
  doc_annual_report: string;
  doc_quarterly_report: string;
  doc_semi_annual_report: string;
  doc_monthly_report: string;
  doc_fund_contract: string;
  doc_product_summary: string;
  doc_offering_announcement: string;
  doc_all_announcements: string;
};
